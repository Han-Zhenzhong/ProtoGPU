...
- 线程分歧与合流（SIMT stack + reconvergence）详见：[doc_design/ptx6.4_sm70/04.01_simt_divergence_and_reconvergence.md](../ptx6.4_sm70/04.01_simt_divergence_and_reconvergence.md)
