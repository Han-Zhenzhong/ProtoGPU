...
- Build and run `cuda/demo/warp_reduce_add_demo_alternative.cu`, and generate PTX override from `cuda/demo/warp_reduce_add_demo_ptx.cu` (inline PTX `warp_reduce_add` end-to-end path via shim + PTX override)
